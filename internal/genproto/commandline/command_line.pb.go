...
type Option struct {
	...
	// details.
	EffectTags []optionfilters.OptionEffectTag `protobuf:"varint,4,rep,packed,name=effect_tags,json=effectTags,proto3,enum=options.OptionEffectTag" json:"effect_tags,omitempty"`
	// Metadata about the flag. See OptionMetadataTag's java documentation for
	// details.
	MetadataTags  []optionfilters.OptionMetadataTag `protobuf:"varint,5,rep,packed,name=metadata_tags,json=metadataTags,proto3,enum=options.OptionMetadataTag" json:"metadata_tags,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Option) GetEffectTags() []optionfilters.OptionEffectTag {
	if x != nil {
		return x.EffectTags
	}
	return nil
...
func (x *Option) GetMetadataTags() []optionfilters.OptionMetadataTag {
	if x != nil {
...
var file_src_main_protobuf_command_line_proto_goTypes = []any{
	...
	(optionfilters.OptionEffectTag)(0),   // 5: options.OptionEffectTag
	(optionfilters.OptionMetadataTag)(0), // 6: options.OptionMetadataTag
}
