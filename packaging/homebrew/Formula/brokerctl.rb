...
# Install:  brew install OWNER/tap/brokerctl
class Brokerctl < Formula
  desc "CLI for the Bazel Broker daemon (ls / watch / kill / drain / profile)"
  homepage "https://github.com/OWNER/bazel-broker"
  version "0.1.0"
  url "https://github.com/OWNER/bazel-broker/releases/download/v#{version}/brokerctl-#{version}.tar.gz"
